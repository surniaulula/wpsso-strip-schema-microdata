...
<tr><th align="right" valign="top" nowrap>Summary</th><td>WPSSO Core add-on to remove outdated / incomplete Schema Microdata to use Google&#039;s preferred Schema JSON-LD for Rich Results SEO.</td></tr>
...
<p><strong>Want to remove incorrect or incomplete Schema Microdata from your webpages and/or theme templates?</strong></p>
...
<p><strong>Is Pinterest picking up duplicate or incorrect Schema from your theme templates?</strong></p>
...
<p>WPSSO Strip Schema Microdata (aka WPSSO SSM) is an add-on for the <a href="https://wordpress.org/plugins/wpsso/">WPSSO Core plugin</a> (Standard or Premium version).</p>
