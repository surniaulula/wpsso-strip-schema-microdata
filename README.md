...
<tr><th align="right" valign="top" nowrap>Summary</th><td>Remove outdated Schema microdata from theme templates to use Schema JSON-LD for better Google SEO Rich Results.</td></tr>
