...
_x( 'WPSSO Core add-on to remove outdated / incomplete Schema Microdata to use Google\'s preferred Schema JSON-LD for Rich Results and SEO.', 'plugin description', 'wpsso-strip-schema-microdata' );
