		...
		public static $cf = array(
			'plugin' => array(
				'wpssossm' => array(
					...
					'name' => 'WPSSO Remove Schema Microdata (WPSSO SSM)',
					'desc' => 'WPSSO extension to remove outdated Schema Microdata and leave the better Schema JSON-LD markup untouched for Google and Bing.',
