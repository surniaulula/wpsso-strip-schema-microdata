...
**Version 1.2.4-dev.4 (2017/10/22)**
...
(2017/10/22) Minor code refactoring for WPSSO v3.46.2: Added a call to the new WpssoHead get_mt_mark() method to return the begin/end regex.
