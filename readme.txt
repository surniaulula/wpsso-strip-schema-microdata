=== WPSSO Strip Schema Microdata from theme templates to use Google's recommended Schema JSON-LD markup ===
...
(2018/02/24) Refactored the WpssoSsm min_version_notice() method to use PHP's trigger_error() and include a notice to refresh plugin update information.
