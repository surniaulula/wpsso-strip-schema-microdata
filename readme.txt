...
**Version 1.2.4-dev.5 (2017/10/23)**
...
(2017/10/23) Minor code refactoring for WPSSO v3.46.2: Added a call to the new WpssoHead get_mt_mark() method to return the begin/end regex.
